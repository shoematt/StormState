...
namespace Orca.Domain.DynamicProperties
{
    public class PropertyValueDescriptor : PropertyDescriptor
    {
        ...
        /// <summary>
        ///   Initializes a new instance of the <see cref = "PropertyValueDescriptor" /> class.
        /// </summary>
        /// <param name = "propertyValue">The property value.</param>
        public PropertyValueDescriptor( PropertyValue propertyValue )
            : base( propertyValue.Name, new Attribute[0] )
        {
            CustomField = propertyValue;
        ...
        public PropertyValue CustomField { get; private set; }
        ...
        {
            var element = component as ISupportPropertyValues;
